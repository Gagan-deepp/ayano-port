    ...
    return (
        <section className="flex-1 flex flex-col min-h-[calc(100vh-8rem)] relative overflow-hidden">
            ...
            <motion.div
                ...
                className="absolute top-[20%] right-8 z-20 hidden md:flex items-center gap-3 px-4 py-2 rounded-2xl bg-white/3 border border-white/5 backdrop-blur-sm hover:bg-white/5 transition-all duration-300 hover:scale-[1.01] cursor-default"
            >
            ...
            <motion.div
                ...
                animate="visible"
                variants={pillVariants}
                className="absolute top-8 left-8 md:left-12 -translate-y-1/2 z-20 hidden md:flex items-center gap-3 px-4 py-2 rounded-2xl bg-white/3 border border-white/5 backdrop-blur-sm hover:bg-white/5 transition-all duration-300 hover:scale-[1.01] cursor-default"
            >
                <div className="relative flex items-center justify-center w-8 h-8 rounded-full bg-white/5 text-white/50 hover:text-white/80 transition-colors">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1}>
            ...
            <motion.div
                ...
                animate="visible"
                variants={pillVariants}
                className="absolute bottom-16 right-8 z-20 hidden md:flex items-center gap-3 px-4 py-2 rounded-2xl bg-white/3 border border-white/5 backdrop-blur-sm hover:bg-white/5 transition-all duration-300 hover:scale-[1.01] cursor-default"
            >
                <div className="relative flex items-center justify-center w-8 h-8 rounded-full bg-white/5 text-white/50 hover:text-white/80 transition-colors">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1}>
            ...
            <motion.div
                ...
                animate="visible"
                variants={pillVariants}
                className="absolute bottom-44 left-16 z-20 hidden md:flex items-center gap-3 px-4 py-2 rounded-2xl bg-white/3 border border-white/5 backdrop-blur-sm hover:bg-white/5 transition-all duration-300 hover:scale-[1.01] cursor-default"
            >
                <div className="relative flex items-center justify-center w-8 h-8 rounded-full bg-white/5 text-white/50 hover:text-white/80 transition-colors">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1}>
            ...
            <footer className="flex justify-between items-end p-8 relative z-10 opacity-60 hover:opacity-100 transition-opacity duration-500">
                ...
                >
                    {/* Twitter/X */}
                    <Link href="https://x.com/ayano_71" target="_blank" className="text-white/30 hover:text-white transition-colors duration-300 transform hover:scale-110">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                    </Link>
                    {/* GitHub */}
                    <Link href="https://github.com/gagan-deepp" target="_blank" className="text-white/30 hover:text-white transition-colors duration-300 transform hover:scale-110">
                    ...
                    {/* LinkedIn */}
                    <Link href="https://www.linkedin.com/in/gagan-deep-singh-666158238" target="_blank" className="text-white/30 hover:text-white transition-colors duration-300 transform hover:scale-110">
