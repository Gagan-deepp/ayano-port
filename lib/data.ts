...
export const projects: Project[] = [
    ...
    },
    {
        ...
        images: [
            "/works/kavach/mock_1.webp",
            "/works/kavach/mock_2.webp",
            "/works/kavach/mock_3.webp",
        ],
    ...
    },
    {
        slug: "evolwe-ring",
        name: "Evolwe Ring",
        type: "Postgres + Mongo + Kafka + Redis + AWS",
        index: "06",
        year: "2025",
        description: "A sophisticated health-tech ecosystem for real-time human biometric analysis and high-fidelity health monitoring.",
        myRole: "As part of the backend team, I focused on the architectural integrity of the bio-metric data pipeline. I implemented Kafka streams to handle the steady, high-volume flow of sleep, stress, and health metrics, ensuring that the transition from hardware signal to digital insight remained seamless and resilient. My work was about maintaining backend complexity while handling the most personal of data—the human rhythm.",
        service: "Distributed Backend & Bio-Data Flow",
        realm: "Wearable Tech / Health-Ops",
        essence: "Human Rhythm. Distributed Logic. Resilience — translating life metrics into technical stability.",
        images: [
            "/works/evolwe/mock_1.webp",
            "/works/evolwe/mock_2.webp",
            // "/works/evolwe/mock_3.webp",
        ],
        cover: "/cover/evolwe_cover.svg",
        github: "#",
        live: "https://play.google.com/store/apps/details?id=com.ring.evolwe&pcampaignid=web_share",
    },
    {
        slug: "pick-me-up",
        name: "Iselle Discord Bot",
        type: "Express + Redis Queue",
        index: "06",
        year: "2024",
        description: "A high-performance Discord bot for Picke Me Up : Infinite Gacha community. It's architected for high-frequency gacha and competitive community systems.",
        myRole: "I architected the asynchronous heartbeat of the server, focusing on a resilient ranking and game subsystem that handles the daily rhythms of a 1.2k+ member community. By implementing Redis queues, I ensured that high-intensity quiz games and gacha rolls remained fluid and responsive, treating every user interaction as a steady, sequenced event in a larger, semi-autonomous flow.",
        service: "Asynchronous Logic & Queue Orchestration",
        realm: "Community Systems / Discord",
        essence: "Responsive. Sequence. Community Flow — 1.2k+ members handled with invisible grace.",
        images: [],
        cover: "/cover/discord_cover.svg",
        github: "#",
        live: "https://discord.com/oauth2/authorize?client_id=1422832085948698708",
    },
];
